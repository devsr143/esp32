...
// class ProgramDropArea extends StatelessWidget {
...
//             final insertIndex = ((details.offset.dy - 18) / 61)
//                 .round()
//                 .clamp(0, vm.program.length);
...
//             vm.insertBlockAt(details.data, index);
//           },
...
//                         if (vm.dropInsertIndex == vm.program.length &&
//                             isHovering)
//                           _buildDropIndicator(),
//                       ],
//                     ),
...
class _ProgramDropAreaState extends State<ProgramDropArea> {
  ...
  int _calculateInsertIndex(
    ...
    // Top padding of the drop area.
    const double topPadding = 18;

    // Approximate height of each block including spacing.
    // Adjust this value according to your CommandBlockWidget height.
    const double blockHeight = 100;

    final adjustedY = localY - topPadding;

    if (adjustedY <= 0) {
      return 0;
    }

    final index = (adjustedY / blockHeight).round();
